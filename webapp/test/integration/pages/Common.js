sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jetCources/MyFirstProject/app", ".html");
		...
		return Opa5.extend("jetCources.MyFirstProject.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jetCources/MyFirstProject/localService/mockserver"], function (mockserver) {
